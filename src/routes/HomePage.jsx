...
const HomePage = () => {
    const tools = [
        ...
        },
        {
            ...
            description:
                "Tạo link multiplayer format để chia sẻ và chơi với bạn bè",
            path: "/link-maker",
            icon: "🔗",
                ...
                <div className="container mx-auto px-4 py-8 relative">
                    <div className="text-center">
                        ...
                        <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto">
                            Bộ công cụ hoàn chỉnh cho người chơi Yu-Gi-Oh!
                            Trading Card Game
                        </p>
                    </div>
                </div>
            ...
            <main className="container mx-auto px-4 py-12">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-400 text-lg max-w-3xl mx-auto">
                        Khám phá các công cụ mạnh mẽ giúp bạn tạo thẻ bài, quản
                        lý deck và kết nối với cộng đồng Yu-Gi-Oh!
                    </p>
                </div>
